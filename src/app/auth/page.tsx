              ...
              {lDone ? (
                ...
                <motion.form key="lform" onSubmit={handleLogin}
                  ...
                  <a href="/api/auth/google"
                    className="flex items-center justify-center gap-3 w-full border-2 border-slate-200 rounded-xl py-3 text-sm font-bold text-slate-700 hover:border-primary hover:bg-primary/5 transition-all">
                  ...
                  <button type="button" onClick={() => setShowForgot(true)}
                    className="text-right w-full text-xs text-primary cursor-pointer hover:underline text-right" onClick={() => { window.location.href = '/reset-password'; }}>Forgot password?</button>
